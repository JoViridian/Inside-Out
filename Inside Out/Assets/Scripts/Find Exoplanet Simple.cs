...
public class FindExoplanetSimple : MonoBehaviour
{
    ...
    {
        if (timer < 1 && GameManager.Instance.zoomedIn)
        {
            return true;
        }
        else
    ...
    {
        string a = "<size=28>" + GetComponentInParent<StarTypeNew>().codename + " " + letter + "</size=28>\n"
            + planetType + "\n"
            + factoid;
        return a;
    }
